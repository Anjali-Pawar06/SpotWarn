...
<body class="dashboard-page">
    ...
    <section class="wrapper scrollable">
        ...
        <section class="title-bar">
            <div class="logo">
                <h1><a href="index.html"><img src="images/WhatsApp Image 2024-06-24 at 8.12.56 PM.jpeg" alt="" height="33%" width="33%"/></a></h1>
            </div>  
            <div style="
        position: absolute; 
        top: 30px; 
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    try {
                        ...
                        PreparedStatement ps1 = con.prepareStatement("select * from add_black_spot where city=?");
